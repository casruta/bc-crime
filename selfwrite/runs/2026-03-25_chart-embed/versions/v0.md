...
![Figure 1: BC Crime Severity Index trend showing the 2003 peak, 2014 trough, and post-2014 plateau](outputs/charts/q1_bc_csi_trend.png)
...
![Figure 2: The violent/non-violent CSI gap has widened since 2014](outputs/charts/q1_violent_nonviolent_gap.png)

![Figure 3: Year-over-year BC crime rate changes — 18 declining years vs. 8 increasing](outputs/charts/q1_bc_yoy_trend.png)

Saskatchewan runs at roughly 2x Ontario's rate. Indexed to 2004 = 100, every comparison province shows a converging downward trajectory, with BC tracking the middle of the pack — the decline is structural, not provincial, driven by demographics, urbanization, and enforcement philosophy more than any single jurisdiction's policy.
...
![Figure 6: The BC-Canada crime rate gap has persisted across the full series](outputs/charts/q1_bc_canada_gap.png)

![Figure 7: Year-over-year change by province — BC's 7.4% drop is second-largest after Alberta](outputs/charts/q1_yoy_by_province.png)

![Figure 8: CSI contribution by violation type — which offences drive BC's overall index](outputs/charts/q1_csi_contribution.png)
...
![Figure 9: Crime composition over time — property crime's share shrinking steadily](outputs/charts/q2_stacked_composition.png)

![Figure 10: Current composition shares by category](outputs/charts/q2_composition_shares.png)
...
![Figure 11: Violation heatmap — intensity by crime type and year](outputs/charts/q2_heatmap.png)

![Figure 12: Largest absolute changes in crime rate over 5 years](outputs/charts/q2_top_changes.png)
...
![Figure 13: Slope ranking — each violation's trajectory over time](outputs/charts/q2_slope_ranking.png)

![Figure 14: Compound annual growth rate by crime category](outputs/charts/q2_category_cagr.png)

![Figure 15: Specific violation trends for key crime types](outputs/charts/q2_specific_violation_trends.png)

![Figure 16: Rising violations spotlight — fastest-growing crime types](outputs/charts/q2_rising_violations_spotlight.png)
...
![Figure 17: Clearance rate trends by crime category — violent stays above 50%, property below 30%](outputs/charts/q3_clearance_rate_trends.png)

![Figure 18: Clearance rates for top 10 violations — wide variation from green (high) to red (low)](outputs/charts/q3_clearance_by_violation.png)
...
![Figure 19: Youth vs. adult CSI — youth crime continues to decline while adult crime stabilizes](outputs/charts/q3_youth_vs_adult_csi.png)

![Figure 20: RCMP vs. municipal policing jurisdiction trends](outputs/charts/q3_rcmp_vs_municipal.png)

![Figure 21: COVID-19 impact on crime — the 2020 dip and post-pandemic rebound](outputs/charts/q3_covid_impact.png)
...
![Figure 22: Unfounded rates over time — stable, ruling out reclassification as a driver of decline](outputs/charts/q3_unfounded_rates.png)
...
![Figure S1: BC policing expenditure trend — nominal vs. inflation-adjusted](outputs/charts/q3_bc_expenditure_trend.png)

![Figure S2: Per-capita policing cost comparison across provinces](outputs/charts/q3_per_capita_comparison.png)

![Figure S3: CSI vs. expenditure overlay — spending rises while crime falls](outputs/charts/q3_csi_vs_expenditure.png)
...
![Figure S4: Expenditure breakdown — salaries and benefits outpace other categories](outputs/charts/q3_expenditure_breakdown.png)

![Figure S5: Police staffing trend — officers per 100,000 population](outputs/charts/q3_staffing_trend.png)

![Figure S6: Crimes per officer with CSI overlay — workload metric](outputs/charts/q3_crimes_per_officer.png)
...
![Figure 24: Top 20 jurisdictions by total crime count](outputs/charts/q4_top_jurisdictions.png)

![Figure 25: Jurisdiction trends — 8 largest jurisdictions over time](outputs/charts/q4_jurisdiction_trends.png)

![Figure 26: CMA per-capita crime rate comparison — interior CMAs at 2x coastal rates](outputs/charts/q4_cma_comparison.png)

![Figure 27: CMA crime rate trends over time](outputs/charts/q4_cma_trends.png)
...
![Figure 28: Total vs. violent crime by jurisdiction](outputs/charts/q4_total_vs_violent.png)

![Figure 29: Crime concentration — cumulative distribution across jurisdictions](outputs/charts/q4_crime_concentration.png)

![Figure 30: Violent crime share distribution by jurisdiction](outputs/charts/q4_violent_share_distribution.png)
...
![Figure 31: Perception vs. reality — public belief in rising crime diverges from actual CSI trend](outputs/charts/q5_perception_vs_reality.png)
...
![Figure 32: Confidence in police by province — BC mirrors the national distribution](outputs/charts/q5_confidence_by_province.png)
