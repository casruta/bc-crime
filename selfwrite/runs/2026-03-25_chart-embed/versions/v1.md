...
![Figure 11: Violation heatmap — colour intensity reveals which crime types dominate in which years](outputs/charts/q2_heatmap.png)
...
![Figure 13: Slope ranking — each violation's trajectory over time, revealing divergent paths](outputs/charts/q2_slope_ranking.png)

![Figure 14: Compound annual growth rate by crime category — which categories are accelerating](outputs/charts/q2_category_cagr.png)
...
![Figure 15: Specific violation trends — tracking key crime types individually over time](outputs/charts/q2_specific_violation_trends.png)

![Figure 16: Rising violations spotlight — the fastest-growing crime types isolated](outputs/charts/q2_rising_violations_spotlight.png)
...
![Figure 18: Clearance rates for top 10 violations — colour-coded from high (green) to low (red)](outputs/charts/q3_clearance_by_violation.png)
...
![Figure 20: RCMP vs. municipal policing jurisdiction crime trends](outputs/charts/q3_rcmp_vs_municipal.png)
...
![Figure 25: Jurisdiction trends — the 8 largest jurisdictions tracked over time](outputs/charts/q4_jurisdiction_trends.png)
...
![Figure 27: CMA crime rate trends over time — diverging trajectories](outputs/charts/q4_cma_trends.png)
...
![Figure 28: Total vs. violent crime by jurisdiction — some areas have disproportionately violent profiles](outputs/charts/q4_total_vs_violent.png)

![Figure 29: Crime concentration — how total crime distributes across jurisdictions](outputs/charts/q4_crime_concentration.png)
