...
Second, the underreporting data points away from a reporting-driven decline. Here is the logic: if fewer people were reporting crimes to police, crime types with low reporting rates would show the largest apparent drops, because even a small change in reporting would have a large proportional effect on their numbers. Violent crime has a lower reporting rate (~24%) than property crime (~35%). If reporting were falling, violent crime numbers should drop faster. The opposite happened: property crime (the more-reported type) fell more steeply. The pattern is inconsistent with a decline driven by changes in reporting behaviour.
