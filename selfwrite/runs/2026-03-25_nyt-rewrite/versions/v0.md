...
Crime in BC is falling, and has been for twenty years. The Crime Severity Index peaked at 166.9 in 2003, dropped 46% to 90.2 by 2014, and fell another 7.4% in 2024. That decline is statistically significant (p < 0.05) and consistent across 18 of the last 26 years.

But 42% of BC residents told Statistics Canada they believe crime is increasing. They are wrong at the aggregate level. They are not wrong about what they see.

This analysis uses 20 years of Statistics Canada data and 42 charts to answer five questions: Is crime rising? What kinds are changing? How well does the justice system respond? Where is crime concentrated? And why does it feel worse than it is?
...
A composite neighbourhood ranking (60% standardized volume, 40% trend direction) classifies areas as high, moderate, or lower concern, identifying the intersections where intervention has the highest expected return.
